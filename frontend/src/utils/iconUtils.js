...
export const getIconUrl = (skillName) => {
  ...
  console.warn(`No icon found for: ${skillName}. Add inline SVG to svgIcons.js or file to LOCAL_ICONS`)
  return null
}
...
export const getIconConfig = (skillName, customFilter = null) => {
  ...
  const filter = (customFilter !== null && customFilter !== undefined) ? customFilter : 'filter-white'
